...
<section class="w3-container">
  ...
  <div class="w3-bar-block">
    ...
    <a href="registration.html.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Registration</a>
...
<?php include '../includes/header.inc.html.php'; ?>
 ...
 <h1>Pricing</h1>
  ...
  <div class="w3-container" id="register" style="margin-top:75px">
    <h1>Registration</h1>
    <hr>
<form id="registrationform" method="POST" action="success.html.php">
      <div class="w3-section">
        ...
        <div class="w3-section">
        <label>Age</label>
        <input class="w3-input w3-border" type="number" name="age" id="age" required>
      </div>    
      <div class="w3-section">
