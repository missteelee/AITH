...
<?php include '../includes/header.inc.html.php'; ?>
        ...
        <p>Our records show you submitted the following:<br>
            <strong>Full Name:</strong> <?php echo htmlspecialchars($fullName, ENT_QUOTES, 'UTF-8'); ?><br>
            ...
            <strong>Emergency Contact:</strong> <?php echo htmlspecialchars($emergencyContact, ENT_QUOTES, 'UTF-8'); ?><br>
            <strong>Emergency Contact Phone:</strong> <?php echo htmlspecialchars($emergencyPhone, ENT_QUOTES, 'UTF-8'); ?><br>
            <strong>Gender ID:</strong> <?php echo htmlspecialchars($gender, ENT_QUOTES, 'UTF-8'); ?><br>
            <strong>Saturday Event Registered for:</strong> <?php echo htmlspecialchars($satEventRegister, ENT_QUOTES, 'UTF-8'); ?><br>
            <strong>Sunday Event Registered for:</strong> <?php echo htmlspecialchars($sunEventRegister, ENT_QUOTES, 'UTF-8'); ?><br>
            <strong>Special Accommodations:</strong> <?php echo htmlspecialchars($specialAccomodations, ENT_QUOTES, 'UTF-8'); ?><br>                       
        </p>
        </div>
    </main>
